...
.error_message {
	background-image: url("/tecnologo/img/error.gif");
...
.notice_message {
	background-image: url("/tecnologo/img/user.gif");
...
.success_message {
	background-image: url("/tecnologo/img/ok.gif");
...
.warning_message {
	background-image: url("/tecnologo/img/warning.gif");
